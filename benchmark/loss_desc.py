...
# --- Prompt模板 ---
PROMPT_TEMPLATE = """
Role: You are an information recovery specialist.

Task: Your task is to create a concise "Information Recovery Note". This note will be used by another AI to restore the meaning of the [Original Text] when it only sees the [Anonymized Text]. The note should describe, in complete sentences, the most critical pieces of information that were lost or generalized during the anonymization.
...
Your Description: The user is a 35-year-old software engineer who lives in Berlin.
...
Your Description: The user's favorite band is Queen. They attended their concert in 1986.
